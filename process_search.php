			...
			while($m=mysqli_fetch_array($qry2))
                   {
					...
					<div class="imageRow">
						  	<div class="single">
						  		...
						  		<a href="booking.php?id=<?php echo $m['movie_id'];?>" rel="lightbox"><img src="img/<?php echo $m['image'];?>" alt="" /></a>
						  	</div>
						  	<div class="movie-text">
						  		<h4 class="h-text"><a href="booking.php?id=<?php echo $m['movie_id'];?>"><?php echo $m['movie_name'];?></a></h4>
